...
export const mockData = {
  ...
  todaySummary: {
    weather: 'Aspen, CO - 42°F, Partly Cloudy',
    crewsOut: 2,
    jobsScheduled: 3,
    onBoard: 24500,
    alerts: [
      { id: 'alert-1', label: '2 invoices overdue', severity: 'warning' },
      { id: 'alert-2', label: '3 callbacks needed from inspections', severity: 'info' }
    ]
  },
  crewTracker: [
    { crew: 'Hugo', job: 'Morrison Residence', address: '124 Aspen Ridge Rd, Aspen', progress: 65, status: 'On Site' },
    { crew: 'Alfredo', job: 'Snowmass Condos', address: '88 Cirque Ln, Snowmass', progress: 10, status: 'En Route' },
    { crew: 'Chris', job: 'Maroon Creek Home', address: '18 Maroon Creek Rd, Aspen', progress: 100, status: 'Completed' },
    { crew: 'Sergio', job: 'Basalt Townhomes', address: '350 Two Rivers Rd, Basalt', progress: 80, status: 'On Site' }
  ],
  cashFlow: {
    moneyIn: 38250,
    moneyOut: 21700,
  ...
  actionItems: [
    { id: 'action-1', label: 'Follow up: Snowmass Condos HOA estimate', detail: '5 days waiting', href: '/estimates', status: 'pending' },
    { id: 'action-2', label: 'Follow up: Alpine Lodge estimate', detail: '3 days waiting', href: '/estimates', status: 'pending' },
    { id: 'action-3', label: 'Follow up: Sopris View Home estimate', detail: '7 days waiting', href: '/estimates', status: 'warning' },
    { id: 'action-4', label: 'Overdue invoice: Roaring Fork Retreat', detail: '$45,750 - 6 days late', href: '/finances', status: 'overdue' },
    { id: 'action-5', label: 'Overdue invoice: Alpine Lodge', detail: '$33,600 - 3 days late', href: '/finances', status: 'overdue' },
    { id: 'action-6', label: 'Inspection scheduled tomorrow: Aspen Highlands Condo', detail: '10:00 AM', href: '/projects', status: 'pending' },
    { id: 'action-7', label: 'Material pickup: Snowmass Condos', detail: 'Thursday 7:00 AM', href: '/projects', status: 'warning' }
  ],
  quickStats: {
    closeRate: 68,
    avgDaysToClose: 4.2,
  ...
  activityFeed: [
    { id: 'activity-1', time: '10:30 AM', label: 'Payment received: Morrison Residence - $21,250' },
    { id: 'activity-2', time: '9:15 AM', label: 'Estimate viewed: Snowmass Condos HOA' },
    { id: 'activity-3', time: 'Yesterday', label: 'Job completed: Valley View Estate' },
    { id: 'activity-4', time: 'Yesterday', label: 'Estimate sent: Roaring Fork Retreat' },
    { id: 'activity-5', time: '2 days ago', label: 'Invoice sent: Alpine Lodge - $33,600' },
    { id: 'activity-6', time: '2 days ago', label: 'Inspection scheduled: Aspen Highlands Condo' }
  ],
  goals: {
    revenueGoal: 175000,
    revenueCurrent: 147500,
    jobsGoal: 12,
    jobsCurrent: 8
  }
};
